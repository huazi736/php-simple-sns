...
Player.prototype = {
	...
	change : function(h) {
		var swf = this.container;
		swf.style.height = parseInt(h);
	},
	...
	AC_GetArgs : function(args, ext, srcParamName, classid, mimeType) {
		...
		ret.embedAttrs["flashvars"] = ret.params["flashvars"] = "autoplay=false";
		ret.embedAttrs["allowFullScreen"] = ret.params["allowFullScreen"] = "true";
		...
		ret.embedAttrs["name"] = ret.objAttrs["name"] = "flashvideouplayer";
		ret.embedAttrs["id"] = ret.objAttrs["id"] = "flashvideouplayer";
		...
		for(var i in args) {
			...
			switch (currArg) {
				case "appendto":
					this.container = ret.container = args[i];
					break;
				case "autoplay":
					ret.embedAttrs["flashvars"] = ret.params["flashvars"] = i + "=" + args[i];
					break;
				case "classid":
					break;
				case "pluginspage":
