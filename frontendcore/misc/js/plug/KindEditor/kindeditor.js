...
K.options = {
	...
	items : [
		...
		'anchor', 'link', 'unlink', '|', 'about', 'oneblock', 'twoblock'
	],
...
_plugin('core', function(K) {
	...
	self.clickToolbar('oneblock', function() {
		self.select().exec('formatblock', '<h2>')
	});
	self.clickToolbar('twoblock', function() {
