...
class DetailForm
{
	...
	public function set_data($data)
	{
		...
		foreach ($this->_eles as $ele => $key) {
			$this->_data[$key] = isset($data[$ele]) ? trim($data[$ele]) : null;
		}
	...
	public function isValid()
	{
		...
		if (mb_strlen($this->_data['detail'], 'utf-8') > 140) {
			$this->_errors['detail'] = "活动详情最多只能有140个字";
		}
		$this->_data = array_map('htmlspecialchars', $this->_data);
