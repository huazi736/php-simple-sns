		...
		<div class="modlueBody">
			...
			<!-- start: 活动 -->
				<div id="contentArea">
						...
						<div class="streamComposer" style="display:block;">
							<div id="distributeInfoBody">
								...
								<ul id="composerAttachments" class="clearfix">
									...
									<!--<li class="s_video" ref="2" style="display:none;"><span><i class="uiIconP icons1 bp_video"></i>视频</span></li>-->
								</ul>
					...
					<div id="eventGuest">
						<!--{if $is_show_users == true || $is_create==ture}-->
						<div id="guest_going">
...
<!--{if $is_create == true}-->
<input type='hidden' id='hd_userName' value='<!--{$webinfo.name}-->' />
<input type='hidden' id='hd_avatar' value='<!--{$webinfo.avatar}-->' />
<input type='hidden' id='hd_userPageUrl' value='<!--{$main_a}-->' />
<!--{else}-->
<input type='hidden' id='hd_userName' value='<!--{$user.username}-->' />
<input type='hidden' id='hd_avatar' value='<!--{$user.avatar}-->' />
<input type='hidden' id='hd_userPageUrl' value='<!--{$dev_main_a}-->' />
<!--{/if}-->
