 ...
 *
 * @author        yangshunjun
 * @version       $Id: appcovermodel.php 26102 2012-05-25 10:44:54Z yangshunjun $
 */
class AppCoverModel extends MY_Model
{
     ...
     */
	public function mergeImages($group = '', $filename = '', $webid = 0, $menuid = 0, $type = 2){
		...
		if($group == '' && $filename == ''){
			...
			//}
			return service('Webpage')->setAppMenuCover($webid, $menuid, '');
		}
		...
		//设置应用区封面
		$result = service('Webpage')->setAppMenuCover($webid, $menuid, $fastdfs_file['filename'], $fastdfs_file['group_name']);
