		...
		<div id="contentCol" class="clearfix home fullRight">
			...
			<div id="contentArea" uid="<!--{$user.uid}-->">	
				<div id="event">
					<div id="leftCol">
						<div id="eventImg">
							<img width="180" height="150" onerror="this.src='<!--{$smarty.const.MISC_ROOT}-->img/default/event.jpg'" alt="活动照片" src="<!--{$smarty.const.MISC_ROOT}-->img/default/event.jpg">
						</div>
						<div class="addEventImg">
							<img width="8" height="8" alt="+" src="<!--{$smarty.const.MISC_ROOT}-->img/system/icon_plus_blue.png">上传活动封面
						</div>
...
<script src="<!--{$smarty.const.MISC_ROOT}-->js/event/event.js?v=<!--{$js_css_v}-->" type="text/javascript"></script>
<!--{/block}-->
