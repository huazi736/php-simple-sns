...
class TheUserWikiModel extends DkModel {
    ...
    public function getPermission($uids, $uid) {
        ...
        foreach ($uids as $key => $val) {
            ...
            $rs[$key]['base'] = $this->isAllow('base', $key, $uid, $key, $isFriend, $isFans);
            $rs[$key]['edu'] = $this->isAllow('edu', $key, $uid, $key, $isFriend, $isFans);
            $rs[$key]['job'] = $this->isAllow('job', $key, $uid, $key, $isFriend, $isFans);
        }
        return $rs;
    }
