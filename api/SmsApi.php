...
class SmsApi extends DkApi {
    ...
    public function __construct($config = array()) {
        $this->client = get_sms();
        $this->smsLog = DKBase::import('SmsLog', 'sms');
    }
...
//        return $sms->updateSmsLog($id, $data);
    ...
    public function addSmsLog($data) {
        return $this->smsLog->addSmsLog($data);
    }
    ...
    public function updateSmsLog($id, $data) {
        return $this->smsLog->updateSmsLog($id, $data);
    }
    ...
    public function isExistsByID($id) {
        return $this->smsLog->isExistsByID($id);
    }
